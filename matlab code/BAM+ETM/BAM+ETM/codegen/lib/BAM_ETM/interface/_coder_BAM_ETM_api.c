 ...
 * Return Type  : void
 */
void BAM_ETM_api(const mxArray * const prhs[4], const mxArray *plhs[1])
{
  real_T a;
  real_T b;
  real_T vbl;
  ...
  vbl = emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "vbl");
  hbl = emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "hbl");

  /* Invoke the target function */
  res = BAM_ETM(a, b, vbl, hbl);
...
/*
 * File trailer for _coder_BAM_ETM_api.c
 *
 * [EOF]
 */
