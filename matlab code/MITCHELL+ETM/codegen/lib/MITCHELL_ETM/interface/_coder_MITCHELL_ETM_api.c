/*
 * File: _coder_MITCHELL_ETM_api.c
 *
...
#include "_coder_MITCHELL_ETM_mex.h"
 ...
 * Return Type  : void
 */
void MITCHELL_ETM_api(const mxArray * const prhs[2], const mxArray *plhs[1])
{
  real_T a;
  real_T b;
  uint32_T res;
 ...
 * Return Type  : void
 */
void MITCHELL_ETM_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void MITCHELL_ETM_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_MITCHELL_ETM_api.c
 *
 * [EOF]
 */
