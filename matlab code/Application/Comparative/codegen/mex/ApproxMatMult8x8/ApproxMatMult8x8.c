...
static emlrtRSInfo emlrtRSI = { 17,    /* lineNo */
  ...
  "C:\\Users\\USER\\Documents\\One Lab\\Comparing_multipliers\\Application\\Application\\Comparative\\ApproxMatMult8x8.m"/* pathName */
};
...
static emlrtRSInfo s_emlrtRSI = { 11,  /* lineNo */
  "COMPARATIVE_ETM",                   /* fcnName */
  "C:\\Users\\USER\\Documents\\One Lab\\Comparing_multipliers\\Application\\Application\\Comparative\\COMPARATIVE_ETM.m"/* pathName */
};
...
static emlrtBCInfo emlrtBCI = { 1,     /* iFirst */
  ...
  "COMPARATIVE_ETM",                   /* fName */
  "C:\\Users\\USER\\Documents\\One Lab\\Comparing_multipliers\\Application\\Application\\Comparative\\COMPARATIVE_ETM.m",/* pName */
  3                                    /* checkKind */
};

/* Function Definitions */
void ApproxMatMult8x8(const emlrtStack *sp, const real_T T[64], const real_T I
                      [64], real_T sel, real_T res[64])
{
  int32_T i;
  int32_T k;
  real_T acc;
    ...
    while (k < 8) {
      ...
      while (j < 8) {
        ...
        if ((upper_a == 0) || (upper_b == 0)) {
          ...
          t1 = muDoubleScalarRound(mult_selector(&b_st, lower_a, lower_b, sel));
          if (t1 < 4.294967296E+9) {
            if (t1 >= 0.0) {
              b_a = (uint32_T)t1;
            } else {
              b_a = 0U;
            }
          } else if (t1 >= 4.294967296E+9) {
            b_a = MAX_uint32_T;
          } else {
            b_a = 0U;
          }
          ...
          t1 = muDoubleScalarRound(mult_selector(&b_st, upper_a, upper_b, sel));
          if (t1 < 4.294967296E+9) {
            if (t1 >= 0.0) {
              b_a = (uint32_T)t1;
            } else {
          ...
          for (first_one = 0; first_one < 16; first_one++) {
            ...
            UPDATE_DECIMAL(&c_st, &d, t1, lower_approx_bin[first_one]);
            t1 *= 2.0;
          }
