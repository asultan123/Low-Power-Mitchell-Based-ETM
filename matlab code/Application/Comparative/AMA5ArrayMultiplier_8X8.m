...
function C=AMA5ArrayMultiplier_8X8(A,B)
% C = A X B
...
[C23, S22]= AMA5FA(PP(1,3),PP(2,2),C22);
[C24, S23]= AMA5FA(PP(1,4),PP(2,3),C23);
[C25, S24]= AMA5FA(PP(1,5),PP(2,4),C24);
[C26, S25]= AMA5FA(PP(1,6),PP(2,5),C25);
[C27, S26]= AMA5FA(PP(1,7),PP(2,6),C26);
[C28, S27]= AMA5FA(PP(1,8),PP(2,7),C27);
[C29, S28]= HalfAdder(PP(2,8),C28);    % first row of FAs

[C32, S2]= HalfAdder(PP(3,1),S22);
[C33, S32]=AMA5FA(PP(3,2),S23,C32);
[C34 ,S33]=AMA5FA(PP(3,3),S24,C33);
[C35, S34]=AMA5FA(PP(3,4),S25,C34);
[C36, S35]=AMA5FA(PP(3,5),S26,C35);
[C37 ,S36]=AMA5FA(PP(3,6),S27,C36);
[C38, S37]=MAFA(PP(3,7),S28,C37);
[C39, S38]=MAFA(PP(3,8),C29,C38);   % second row of FAS

[C42, S3]= HalfAdder(PP(4,1),S32);
[C43, S42]=AMA5FA(PP(4,2),S33,C42);
[C44 ,S43]=AMA5FA(PP(4,3),S34,C43);
[C45, S44]=AMA5FA(PP(4,4),S35,C44);
[C46, S45]=AMA5FA(PP(4,5),S36,C45);
...
[C53, S52]=AMA5FA(PP(5,2),S43,C52);
[C54 ,S53]=AMA5FA(PP(5,3),S44,C53);
[C55, S54]=AMA5FA(PP(5,4),S45,C54);
...
[C63,S62]=AMA5FA(PP(6,2),S53,C62);
[C64,S63]=AMA5FA(PP(6,3),S54,C63);
