...
static emlrtRSInfo emlrtRSI = { 17,    /* lineNo */
  ...
  "C:\\Users\\USER\\Documents\\One Lab\\Comparing_multipliers\\Application\\Application\\EVO\\ApproxMatMult8x8.m"/* pathName */
};
...
static emlrtRSInfo s_emlrtRSI = { 11,  /* lineNo */
  "mult_ETM_int",                      /* fcnName */
  "C:\\Users\\USER\\Documents\\One Lab\\Comparing_multipliers\\Application\\Application\\EVO\\mult_ETM_int.m"/* pathName */
};
...
static emlrtBCInfo emlrtBCI = { 1,     /* iFirst */
  ...
  "mult_ETM_int",                      /* fName */
  "C:\\Users\\USER\\Documents\\One Lab\\Comparing_multipliers\\Application\\Application\\EVO\\mult_ETM_int.m",/* pName */
  3                                    /* checkKind */
};
  ...
  while (i < 8) {
    ...
    while (k < 8) {
      ...
      while (j < 8) {
        ...
        i0 = (int32_T)muDoubleScalarRound((real_T)(a & 65280) * 0.00390625);
        u0 = (uint16_T)i0;
        upper_a = (uint8_T)u0;
        i0 = (int32_T)muDoubleScalarRound((real_T)(b & 65280) * 0.00390625);
        u0 = (uint16_T)i0;
        upper_b = (uint8_T)u0;
        ...
        if ((upper_a == 0) || (upper_b == 0)) {
          ...
          qY = mult_selector(&b_st, lower_a, lower_b, sel);
          ...
          b_a = mult_selector(&c_st, upper_a, upper_b, sel);
