 ...
 * Return Type  : void
 */
void TBM_ETM_api(const mxArray * const prhs[2], const mxArray *plhs[1])
{
  real_T a;
  real_T b;
  uint32_T res;
...
/*
 * File trailer for _coder_TBM_ETM_api.c
 *
 * [EOF]
 */
