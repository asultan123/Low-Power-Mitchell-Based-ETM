...
//
unsigned short mul8_347(double a, double b)
{
  unsigned short c;
  double d10;
  unsigned short b_a;
  ...
  return (unsigned short)(c | n4 | n1216 << 3 | (b_a & 1 & n20) << 5 | (n157 & 1)
    << 6 | ((unsigned short)(n22 ^ n157) & 1) << 7 | (((int)((unsigned int)b_b >>
    1) & 1 & n12) | n890) << 8 | ((unsigned short)((unsigned short)(n683 & 65535)
