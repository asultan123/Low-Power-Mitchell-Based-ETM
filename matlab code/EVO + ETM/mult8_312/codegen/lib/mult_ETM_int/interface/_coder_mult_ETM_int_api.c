/*
 * File: _coder_mult_ETM_int_api.c
 *
 ...
 * Return Type  : void
 */
void mult_ETM_int_api(const mxArray * const prhs[3], const mxArray *plhs[1])
{
  real_T a;
  real_T b;
  real_T selector;
 ...
 * Return Type  : void
 */
void mult_ETM_int_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void mult_ETM_int_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_mult_ETM_int_api.c
 *
 * [EOF]
 */
