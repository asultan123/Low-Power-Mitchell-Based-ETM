...
#include "_coder_EXACT_ETM_mex.h"
 ...
 * Return Type  : void
 */
void EXACT_ETM_api(const mxArray * const prhs[2], const mxArray *plhs[1])
{
  real_T a;
  real_T b;
  uint32_T res;
 ...
 * Return Type  : void
 */
void EXACT_ETM_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_EXACT_ETM_api.c
 *
 * [EOF]
 */
